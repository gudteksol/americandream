  ...
  return (
    <div className="min-h-screen bg-[#f4e8d8] newspaper-texture">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 p-4 bg-[#8b0000] hover:bg-[#a00000] text-white shadow-2xl hover:shadow-[0_0_30px_rgba(139,0,0,0.6)] transition-all duration-300 transform hover:scale-110 border-4 border-[#2c1810] z-40 group"
